...
to setup
 ...
 create-station1 1 [set xcor feetToX 1761097.244 set ycor feetToy 1705385.708
   set size 2
   set shape "station"]
 create-station1 1 [ set xcor feetToX 1751789.137 set ycor feetToy 1705432.601
   set size 2
   set shape "station"
 ]
 
 create-station1 1 [ set xcor feetToX 1729405.875 set ycor feetToy 1705293.031 
   set size 2
   set shape "station"
 ]
 
 create-station1 1 [ set xcor feetToX 1723232.329 set ycor feetToy 1700721.975 
   set size 2
   set shape "station"
 ]
...
to go
  ...
  [ 
    ...
    forward random-normal 0.05 0.05
    let h gis:raster-sample aspect self
...
to produce-rain
  ...
  if timerain <= 0[
    set rainy (3000 + random 7000) * precipitation 
   create-waters rainy
    [ setxy random 80 random 80
      set color blue
      set timetodie 500 + random 1500
      set shape "circle"
      set size 0.5
      let h gis:raster-sample aspect self
      ifelse h >= -360
...
to datado
  ...
  set-current-plot-pen "water2"
   plot [count waters in-radius 5] of patch (feetToX 1761097.244) (feetToy 1705385.708) 
   
   set-current-plot "plot 2"
   set-current-plot-pen "water3"
   plot [count waters in-radius 5] of patch (feetToX 1706432.788) (feetToy 1749710.003)
